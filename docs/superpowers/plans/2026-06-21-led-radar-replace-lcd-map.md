...
- [ ] **Step 1: 메인 루프에서 매 틱 `LED레이더표시()` 호출**
...
- [ ] **Step 3: "핵심 변화" 11번 항목을 5x5 LED 교체로 재작성**
...
- [ ] **Step 5: "LCD 레이더맵 색상" 섹션을 "5x5 LED 밝기" 섹션으로 교체**
